...
- state-space non-rectangular matrix and unitful coefficient diagnostics
...
- component solver result trajectory artifact adapter for internal dynamic-component SolverResult output
