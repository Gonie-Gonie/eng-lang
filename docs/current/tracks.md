...
- component-local delay(signal, duration) diagnostics for port and prior local signals
- component-local Predictor and external behavior signal diagnostics for port and prior local signals
