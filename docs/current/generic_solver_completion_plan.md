...
| DAE solve | Small unitful temperature implicit-Euler DAE bridge with identity/mass-matrix fallback. | State/algebraic partitioning, consistent initialization, mass matrix support, events, adaptive stepping, and higher-order methods. |
