...
| Component parameters | System-local component instances support empty constructors plus declared component parameter defaults and named constructor overrides for numeric literal values, with unit checks, diagnostics, and review/report-spec parameter provenance. | Remaining work is broad constructor arity/default policy, unit conversion into canonical solver parameter values, non-literal bindings, and parameter references preserved through the generic residual IR instead of simple substitution. |
