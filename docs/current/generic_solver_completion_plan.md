...
| Component parameters | System-local component instances support empty constructors and named literal argument substitution into component-local boundary/equation seeds. | Constructor declarations, defaults, parameter binding, unit conversion, artifact serialization, and solver-wide parameter metadata must be broad and typed. |
