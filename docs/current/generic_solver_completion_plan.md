...
| Component parameters | System-local component instances support empty constructors plus declared component parameter defaults and named constructor overrides for numeric literal values, with unit checks, diagnostics, review/report-spec parameter provenance, and qualified parameter references preserved into component residual dependencies. Static linear residual assembly plus source Newton/DAE residual evaluation now consume materialized parameter values, including the official parameterized nonlinear HeatRate fixture. | Remaining work is broad constructor arity/default policy, canonical solver-unit policy across all source paths, non-literal bindings, and full expression lowering for broader parameterized nonlinear/dynamic terms. |
