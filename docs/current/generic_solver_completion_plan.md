...
| Algebraic nonlinear solve | Newton is bridged for narrow scalar source residuals, including unitful HeatRate residuals. | Multi-variable nonlinear residual graphs with scaling, Jacobian policy, line search or trust region, diagnostics, and failure artifacts. |
