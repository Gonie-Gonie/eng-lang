...
| LSP/VS Code | Persistent stdio document sync, diagnostics, cancellable editor requests, direct protocol semantic tokens, compiler-derived user-function/class-method signature help, compatibility CLI endpoints, and optional VS Code source exist. | Implemented internal editor service, without a public cross-release compatibility guarantee. |
