...
| LSP/editor check | `dev.bat lsp-check` | Runs library, persistent-stdio, semantic-token, visual-contract, exact-source and token-free-trivia analysis-cache, full-fallback, and recursive import-invalidation regressions. |
