...
| SOLVER-403 | Dynamic component fixed-step solver | Implemented as solver-API explicit/semi-implicit component seeds plus a narrow source `solve component_graph` path for arithmetic-linear dynamic component assemblies using the shared residual expression linearizer. |
