...
| SOLVER-301 | Component instance and port graph collection | Implemented for top-level component fixtures and supported system-local `name = Component(...)` instances with empty constructors or named literal arguments. |
