...
| SOLVER-404 | Nonlinear Newton seed | Implemented as standalone solver-API seed. |
| SOLVER-405 | DAE implicit Euler seed | Implemented as standalone solver-API seed. |
