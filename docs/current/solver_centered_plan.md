...
| SOLVER-406 | Dynamic component adaptive Heun source path | Implemented narrowly for algebraic-free parsed derivative residual component graphs as `solver = dynamic_component_adaptive_heun`, with fixed output-grid trajectories, accepted-substep diagnostics, and explicit unsupported artifacts for algebraic dynamic component graphs. |
