...
| Uncertainty core | Experimental | Official example, deterministic samples, source diagnostics, propagation transform metadata, histogram artifact path on `main` | v1.1 release gate not completed | v1.1 |
