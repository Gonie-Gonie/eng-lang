...
| LSP | Experimental | `eng-lsp.exe` smoke/snapshot, stdio round-trip tests, package-smoke inclusion, line diagnostics, basic completion, hover, and minimal stdio JSON-RPC on `main` | Not editor-validated as a release path | v1.3 gate |
