...
- Evidence: `eng-lsp.exe` smoke/editor-request checks, a versioned persistent
  ...
  absolute token anchors, lazy shared editor snapshots, recursive import-dependent invalidation, a VS Code
...
- Not included: a stable public compatibility guarantee across EngLang releases
  or general partial parse/semantic recomputation for token-changing or
  source-position-shifting edits inside a changed document.
