...
| `eng.report` | Native workflow support | eng_report | `report_spec`<br>`report_html`<br>`review`<br>`output_manifest` | `none_current` | `examples/workflows/03_uncertain_sensor_report` | `cargo test -p eng_report` |
...
| `eng.plot` | Native workflow support | eng_report | `plot_spec`<br>`plot_manifest`<br>`plot_svg`<br>`output_manifest` | `none_current` | `examples/official/01_csv_plot`<br>`examples/workflows/03_uncertain_sensor_report` | `cargo test -p eng_report plot` |
