...
- VS Code navigation: current-file definition/highlights, static-import-aware workspace references and safe rename, and workspace symbol search are implemented; broader package/index identities remain open.
