...
```bat
git tag v0.4-preview
git push origin v0.4-preview
```
...
`v0.5-preview` or a clearly scoped patch label only after updating
`docs/current/version_plan.md`.

## GitHub Release

Use `docs\release\v0.4-preview.md` as the public release note.
...
[ ] release assets match v0.4-preview public labels
```
