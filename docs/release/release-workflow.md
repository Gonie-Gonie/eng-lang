...
`v0.9-preview` or a clearly scoped patch label only after updating
`docs/current/version_plan.md`.

## GitHub Release

Use `docs\release\v0.8-preview.md` as the public release note.
...
[ ] release assets match v0.8-preview public labels
```
