...
```bat
git tag v0.7-preview
git push origin v0.7-preview
```
...
`v0.8-preview` or a clearly scoped patch label only after updating
`docs/current/version_plan.md`.

## GitHub Release

Use `docs\release\v0.7-preview.md` as the public release note.
...
[ ] release assets match v0.7-preview public labels
```
