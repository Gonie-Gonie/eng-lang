...
| Field | Example | Meaning |
|---|---|---|
| `runtime_version` | `0.4.0-preview` | Runtime version embedded in the bundled CLI. |
| `compiler_version` | `0.4.0-preview` | Compiler/build version used to create the package. |
