...
fn assert_native_ide_ui_behavior_status_labels() -> Result<(), String> {
    ...
    for required in [
        ...
        r#"{ key: "systems", label: "System" }"#,
        r#"modifiers.includes("solver")"#,
        ...
        r#"time_alignment_result_field: "Time alignment result field""#,
        ...
        r#"modifiers.includes("validation")"#,
        r#"modifiers.includes("workflowStep")"#,
        r#"add("workflow")"#,
        r#"add("case")"#,
        r#"modifiers.includes("cache")"#,
        "String(token?.type || \"\") === \"namespace\"",
        r#"modifiers.includes("defaultLibrary")"#,
        r#"modifiers.includes("imported")"#,
        r#"add("modules")"#,
        r#"modifiers.includes("sideEffect")"#,
    ...
    if app_js.contains("FALLBACK_LEXICAL_CONSTANTS") {
        return Err(
            "native IDE constant fallback must use syntax_catalog.constants instead of a JS fallback list"
                .to_owned(),
        );
    }
            ...
            "network_boundaries": [
              {
                ...
                "response_source": "offline_response",
                ...
                "case_tables": [
                  {
                    ...
                    "scheduler_hooks": ["case_queued", "case_started", "case_failed"],
                    "parallel_policy": "not_configured",
