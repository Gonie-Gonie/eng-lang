...
pub struct ClassObjectInfo {
    ...
    pub source_object_span: Option<SourceSpan>,
...
fn sample_table_field_semantic_type(
    expression: &str,
    typed_bindings: &[TypedBinding],
) -> Option<SemanticType> {
    let (binding_name, field) = expression.trim().split_once('.')?;
    let has_sample_table = typed_bindings.iter().any(|binding| {
...
fn analyze_class_object_decl(
    ...
    class_objects.push(ClassObjectInfo {
        ...
        class_name_span: Some(object.class_name_span),
        source_object: None,
        source_object_span: None,
...
fn analyze_class_object_copy_decl(
    ...
    class_objects.push(ClassObjectInfo {
        ...
        source_object_span: Some(object.source_name_span),
...
fn analyze_port(declaration: &PortDecl, component: &mut ComponentInfo) {
    ...
    component.ports.push(PortInfo {
        ...
        domain_span: declaration.domain_span,
