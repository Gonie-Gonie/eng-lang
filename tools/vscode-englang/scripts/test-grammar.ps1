...
Assert-WorkflowBeginCaptureScope -Name "meta.workflow.legacy-model-train.englang" -Begin "\b(regression_table|train_regression)\s*(\()" -CaptureIndex "1" -Scope "support.function.deprecated.englang" -Description "legacy model train call"
