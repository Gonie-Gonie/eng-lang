...
```bat
target\debug\eng.exe check examples\advanced_solver\20_multi_state_thermal\main.eng --review
target\debug\eng.exe run examples\advanced_solver\20_multi_state_thermal\main.eng --save-artifacts
```
