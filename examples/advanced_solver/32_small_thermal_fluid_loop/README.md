...
- component-local boundary and pressure-drop sources materialized from typed component parameters;
...
- the Fluid fixture uses the public `Pressure [Pa]` quantity and a fixed pipe
