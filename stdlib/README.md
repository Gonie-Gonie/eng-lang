...
| `eng.table` | Promoted table diagnostics, deterministic row selection, and schema-aware filter/select/require_one/join transform records. |
...
| `eng.table` | Planned broader APIs | Derived columns, sort, and richer schema-aware transforms. |
