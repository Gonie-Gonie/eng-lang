...
| `eng.table` | Promoted table diagnostics, deterministic row selection, and schema-aware filter/select/sort/require_one/join transform records. |
...
| `eng.table` | Planned broader APIs | Derived columns and richer schema-aware transforms. |
