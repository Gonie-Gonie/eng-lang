...
| `eng.quality` | Supported seed | Common quality result projection for validations, schema constraints, and TimeSeries quality summaries; expectation suites remain planned. |
